## TTGO T-Beam Motion Detector for The Things Network

forked from https://github.com/kizniche/ttgo-tbeam-ttn-tracker and Removed GPS funktionality

Uploads Motion data from the TTGO T-Beam to [The Things Network](https://www.thethingsnetwork.org) (TTN) and [TTN Mapper](https://ttnmapper.org) for tracking and determining signal strength of LoRaWAN gateways and nodes.
